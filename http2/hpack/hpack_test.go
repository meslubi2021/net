...
func TestDecoderDecode(t *testing.T) {
	tests := []struct {
		...
		{"happy flow 4 way (A1->B1->A2->B2)", [][]byte{{0x83, 0x86, 0x45, 0x95, 0x62, 0x72, 0xd1, 0x41, 0xfc, 0x1e, 0xca, 0x24, 0x5f, 0x15, 0x85, 0x2a, 0x4b, 0x63, 0x1b, 0x87, 0xeb, 0x19, 0x68, 0xa0, 0xff, 0x41, 0x8b, 0xa0, 0xe4, 0x1d, 0x13, 0x9d, 0x9, 0xb8, 0xd3, 0x6f, 0xb6, 0xcf, 0x5f, 0x8b, 0x1d, 0x75, 0xd0, 0x62, 0xd, 0x26, 0x3d, 0x4c, 0x4d, 0x65, 0x64, 0x7a, 0x8a, 0x9a, 0xca, 0xc8, 0xb4, 0xc7, 0x60, 0x2b, 0xb4, 0xea, 0xe0, 0x40, 0x2, 0x74, 0x65, 0x86, 0x4d, 0x83, 0x35, 0x5, 0xb1, 0x1f, 0x40, 0x89, 0x9a, 0xca, 0xc8, 0xb2, 0x4d, 0x49, 0x4f, 0x6a, 0x7f, 0x86, 0x7d, 0xf7, 0xdf, 0x8, 0x9e, 0xb7},
			...
			{0x83, 0x86, 0xc5, 0xc4, 0xc3, 0xc2, 0xc1, 0x7e, 0x86, 0x6d, 0xf7, 0xdd, 0xb, 0x8d, 0x5b},
			{0x83, 0x86, 0xc0, 0xc5, 0xc4, 0xc3, 0xc2, 0x7e, 0x86, 0x6d, 0xf7, 0xdc, 0x79, 0xf0, 0xdb},
		},
			[][]HeaderField{
				{
					pair(":method", "POST"),
		...
		{"lost one request (A1->B1->B2)", [][]byte{{0x83, 0x86, 0x45, 0x95, 0x62, 0x72, 0xd1, 0x41, 0xfc, 0x1e, 0xca, 0x24, 0x5f, 0x15, 0x85, 0x2a, 0x4b, 0x63, 0x1b, 0x87, 0xeb, 0x19, 0x68, 0xa0, 0xff, 0x41, 0x8b, 0xa0, 0xe4, 0x1d, 0x13, 0x9d, 0x9, 0xb8, 0xd3, 0x6f, 0xb6, 0xcf, 0x5f, 0x8b, 0x1d, 0x75, 0xd0, 0x62, 0xd, 0x26, 0x3d, 0x4c, 0x4d, 0x65, 0x64, 0x7a, 0x8a, 0x9a, 0xca, 0xc8, 0xb4, 0xc7, 0x60, 0x2b, 0xb4, 0xea, 0xe0, 0x40, 0x2, 0x74, 0x65, 0x86, 0x4d, 0x83, 0x35, 0x5, 0xb1, 0x1f, 0x40, 0x89, 0x9a, 0xca, 0xc8, 0xb2, 0x4d, 0x49, 0x4f, 0x6a, 0x7f, 0x86, 0x7d, 0xf7, 0xdf, 0x8, 0x9e, 0xb7},
			{0x83, 0x86, 0x45, 0x9b, 0x62, 0xbb, 0xe, 0x93, 0xc7, 0x6c, 0xab, 0xee, 0x4d, 0x85, 0x1d, 0x3b, 0x8b, 0x67, 0x73, 0x10, 0xac, 0x61, 0x2a, 0x49, 0x3e, 0xd2, 0xa2, 0xb3, 0xd4, 0x82, 0xff, 0xc3, 0xc2, 0xc1, 0xc0, 0x7f, 0x0, 0x86, 0x7d, 0xf7, 0xde, 0x71, 0x97, 0xad},
			{0x83, 0x86, 0xc0, 0xc5, 0xc4, 0xc3, 0xc2, 0x7e, 0x86, 0x6d, 0xf7, 0xdc, 0x79, 0xf0, 0xdb},
		},
			[][]HeaderField{
		...
		{"happy flow 3 way (B1->A2->B2)", [][]byte{
			{0x83, 0x86, 0x45, 0x9b, 0x62, 0xbb, 0xe, 0x93, 0xc7, 0x6c, 0xab, 0xee, 0x4d, 0x85, 0x1d, 0x3b, 0x8b, 0x67, 0x73, 0x10, 0xac, 0x61, 0x2a, 0x49, 0x3e, 0xd2, 0xa2, 0xb3, 0xd4, 0x82, 0xff, 0xc3, 0xc2, 0xc1, 0xc0, 0x7f, 0x0, 0x86, 0x7d, 0xf7, 0xde, 0x71, 0x97, 0xad},
			{0x83, 0x86, 0xc5, 0xc4, 0xc3, 0xc2, 0xc1, 0x7e, 0x86, 0x6d, 0xf7, 0xdd, 0xb, 0x8d, 0x5b},
			{0x83, 0x86, 0xc0, 0xc5, 0xc4, 0xc3, 0xc2, 0x7e, 0x86, 0x6d, 0xf7, 0xdc, 0x79, 0xf0, 0xdb},
		},
			...
			[]HeaderField{
				pair(":path", "/protobuf.StreamService/FetchResponse")},
			[]error{DecodingError{errors.New("invalid indexed representation")}, errors.New("invalid indexed representation"), errors.New("invalid indexed representation")},
		},
		{"happy flow 4 way (A2->B2)", [][]byte{
			{0x83, 0x86, 0xc5, 0xc4, 0xc3, 0xc2, 0xc1, 0x7e, 0x86, 0x6d, 0xf7, 0xdd, 0xb, 0x8d, 0x5b},
			{0x83, 0x86, 0xc0, 0xc5, 0xc4, 0xc3, 0xc2, 0x7e, 0x86, 0x6d, 0xf7, 0xdc, 0x79, 0xf0, 0xdb},
		},
			[][]HeaderField{
			...
			[]HeaderField{},
			[]error{DecodingError{errors.New("invalid indexed representation")}, DecodingError{errors.New("invalid indexed representation")}},
		},
		...
		{"buffer with leftovers creating encoding issue", [][]byte{{0x83, 0x86, 0x45, 0x95, 0x62, 0x72, 0xd1, 0x41, 0xfc, 0x1e, 0xca, 0x24, 0x5f, 0x15, 0x85, 0x2a, 0x4b, 0x63, 0x1b, 0x87, 0xeb, 0x19, 0x68, 0xa0, 0xff, 0x41, 0x8b, 0xa0, 0xe4, 0x1d, 0x13, 0x9d, 0x9, 0xb8, 0xd3, 0x6f, 0xb6, 0xcf, 0x5f, 0x8b, 0x1d, 0x75, 0xd0, 0x62, 0xd, 0x26, 0x3d, 0x4c, 0x4d, 0x65, 0x64, 0x7a, 0x8a, 0x9a, 0xca, 0xc8, 0xb4, 0xc7, 0x60, 0x2b, 0xb4, 0xea, 0xe0, 0x40, 0x2, 0x74, 0x65, 0x86, 0x4d, 0x83, 0x35, 0x5, 0xb1, 0x1f, 0x40, 0x89, 0x9a, 0xca, 0xc8, 0xb2, 0x4d, 0x49, 0x4f, 0x6a, 0x7f, 0x86, 0x7d, 0xf7, 0xdf, 0x8, 0x9e, 0xb7},
			{0x8, 0x9e, 0xb7, 0x86, 0x45, 0x9b, 0x62, 0xbb, 0xe, 0x93, 0xc7, 0x6c, 0xab, 0xee, 0x4d, 0x85, 0x1d, 0x3b, 0x8b, 0x67, 0x73, 0x10, 0xac, 0x61, 0x2a, 0x49, 0x3e, 0xd2, 0xa2, 0xb3, 0xd4, 0x82, 0xff, 0xc3, 0xc2, 0xc1, 0xc0, 0x7f, 0x0, 0x86, 0x7d, 0xf7, 0xde, 0x71, 0x97, 0xad}},
			[][]HeaderField{
				{
					pair(":method", "POST"),
					pair(":scheme", "http"),
			...
			[]HeaderField{
				...
				pair(":authority", "localhost:45953"),
				pair(":path", "/helloworld.Greeter/SayHello")},
			[]error{nil, errors.New("invalid Huffman-encoded data")},
		},

		{"buffer with leftovers creating wrong index issue", [][]byte{{0x83, 0x86, 0x45, 0x95, 0x62, 0x72, 0xd1, 0x41, 0xfc, 0x1e, 0xca, 0x24, 0x5f, 0x15, 0x85, 0x2a, 0x4b, 0x63, 0x1b, 0x87, 0xeb, 0x19, 0x68, 0xa0, 0xff, 0x41, 0x8b, 0xa0, 0xe4, 0x1d, 0x13, 0x9d, 0x9, 0xb8, 0xd3, 0x6f, 0xb6, 0xcf, 0x5f, 0x8b, 0x1d, 0x75, 0xd0, 0x62, 0xd, 0x26, 0x3d, 0x4c, 0x4d, 0x65, 0x64, 0x7a, 0x8a, 0x9a, 0xca, 0xc8, 0xb4, 0xc7, 0x60, 0x2b, 0xb4, 0xea, 0xe0, 0x40, 0x2, 0x74, 0x65, 0x86, 0x4d, 0x83, 0x35, 0x5, 0xb1, 0x1f, 0x40, 0x89, 0x9a, 0xca, 0xc8, 0xb2, 0x4d, 0x49, 0x4f, 0x6a, 0x7f, 0x86, 0x7d, 0xf7, 0xdf, 0x8, 0x9e, 0xb7},
			{0xdf, 0x8, 0x9e, 0xb7, 0x86, 0x45, 0x9b, 0x62, 0xbb, 0xe, 0x93, 0xc7, 0x6c, 0xab, 0xee, 0x4d, 0x85, 0x1d, 0x3b, 0x8b, 0x67, 0x73, 0x10, 0xac, 0x61, 0x2a, 0x49, 0x3e, 0xd2, 0xa2, 0xb3, 0xd4, 0x82, 0xff, 0xc3, 0xc2, 0xc1, 0xc0, 0x7f, 0x0, 0x86, 0x7d, 0xf7, 0xde, 0x71, 0x97, 0xad}},
			[][]HeaderField{
				{
					pair(":method", "POST"),
					pair(":scheme", "http"),
			...
			[]HeaderField{
				...
				pair(":authority", "localhost:45953"),
				pair(":path", "/helloworld.Greeter/SayHello")},
			[]error{nil, errors.New("invalid indexed representation")},
		},

		{"buffer with leftovers creating truncated headers", [][]byte{{0x83, 0x86, 0x45, 0x95, 0x62, 0x72, 0xd1, 0x41, 0xfc, 0x1e, 0xca, 0x24, 0x5f, 0x15, 0x85, 0x2a, 0x4b, 0x63, 0x1b, 0x87, 0xeb, 0x19, 0x68, 0xa0, 0xff, 0x41, 0x8b, 0xa0, 0xe4, 0x1d, 0x13, 0x9d, 0x9, 0xb8, 0xd3, 0x6f, 0xb6, 0xcf, 0x5f, 0x8b, 0x1d, 0x75, 0xd0, 0x62, 0xd, 0x26, 0x3d, 0x4c, 0x4d, 0x65, 0x64, 0x7a, 0x8a, 0x9a, 0xca, 0xc8, 0xb4, 0xc7, 0x60, 0x2b, 0xb4, 0xea, 0xe0, 0x40, 0x2, 0x74, 0x65, 0x86, 0x4d, 0x83, 0x35, 0x5, 0xb1, 0x1f, 0x40, 0x89, 0x9a, 0xca, 0xc8, 0xb2, 0x4d, 0x49, 0x4f, 0x6a, 0x7f, 0x86, 0x7d, 0xf7, 0xdf, 0x8, 0x9e, 0xb7},
			{0x86, 0x7d, 0xdf, 0x8, 0x9e, 0xb7, 0x86, 0x45, 0x9b, 0x62, 0xbb, 0xe, 0x93, 0xc7, 0x6c, 0xab, 0xee, 0x4d, 0x85, 0x1d, 0x3b, 0x8b, 0x67, 0x73, 0x10, 0xac, 0x61, 0x2a, 0x49, 0x3e, 0xd2, 0xa2, 0xb3, 0xd4, 0x82, 0xff, 0xc3, 0xc2, 0xc1, 0xc0, 0x7f, 0x0, 0x86, 0x7d, 0xf7, 0xde, 0x71, 0x97, 0xad}},
			[][]HeaderField{
				{
					pair(":method", "POST"),
					pair(":scheme", "http"),
	...
	for _, tt := range tests {
		...
		for index, current := range tt.in {
			...
			if err != nil {
				...
				t.Errorf("%s: %v, want: %v", tt.name, err, tt.err)
				continue
			}
